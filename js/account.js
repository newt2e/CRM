      ...
      '<div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:16px">' +
        ...
        (function() {
          ...
          return '<div style="display:flex;align-items:center;gap:8px">' +
            '<button id="acc-prev" ' + (prev ? 'data-aid="' + prev.id + '"' : 'disabled') + ' style="width:32px;height:32px;border-radius:8px;border:1.5px solid rgba(255,255,234,.25);background:rgba(255,255,234,.1);cursor:' + (prev?'pointer':'default') + ';color:' + (prev?'var(--nt)':'rgba(255,255,234,.25)') + ';font-size:18px;line-height:1;display:flex;align-items:center;justify-content:center" title="' + (prev?prev.name:'First account') + '">‹</button>' +
            '<button id="acc-next" ' + (next ? 'data-aid="' + next.id + '"' : 'disabled') + ' style="width:32px;height:32px;border-radius:8px;border:1.5px solid rgba(255,255,234,.25);background:rgba(255,255,234,.1);cursor:' + (next?'pointer':'default') + ';color:' + (next?'var(--nt)':'rgba(255,255,234,.25)') + ';font-size:18px;line-height:1;display:flex;align-items:center;justify-content:center" title="' + (next?next.name:'Last account') + '">›</button>' +
